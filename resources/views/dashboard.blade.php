                ...
                <tbody>
                    ...
                    <tr class="border border-red-500 text-white bg-black">
                        ...
                        <td class="px-3 py-2">
                            ...
                            <form action="{{ route('vehicles.destroy', $v) }}" method="POST" class="inline-block delete-form">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="px-2 py-1 text-sm bg-black border border-red-500 text-red-500 rounded hover:bg-black hover:border-white hover:text-white delete-btn">Delete</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
    ...
    <div class="bg-black w-full max-w-lg p-4 rounded border border-red-500">
        ...
        <form id="edit-vehicle-form" method="POST">
            ...
            <div class="mt-3 flex gap-2 justify-end">
                ...
                <button type="submit" class="px-4 py-2 bg-black text-red-500 bg-black border border-red-500 rounded hover:bg-black hover:text-white hover:border-white">Save</button>
            </div>
        </form>
    </div>
</div>
